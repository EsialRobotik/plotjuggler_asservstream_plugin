...
class AsservStreamControlPanel: public QMainWindow
{
    Q_OBJECT
public:
    explicit AsservStreamControlPanel(Ui_AsservStreamControlPanel *ui, AsservStream_uartDecoder *uartDecoder,  int fd, int logFd = -1);
...
public slots:
    ...
    void on_distance_acc_simple_update_btn_clicked();
